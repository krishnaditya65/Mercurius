...
real corporate-actions detection itself, §14, remains unbuilt).
...
statement export and cross-device watchlist/P&L widget were NOT part of
this round and remain unbuilt.
